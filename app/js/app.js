        ...
        */
        ...
        Local = (function() {
          function Local(model) {
            ...
            this.model.on('save change', this.save);
            if (this.model instanceof Base.Collection) {
              this.model.on('save:model change:model', this.save);
            }
          }

          Local.prototype.fetch = function() {
            var json;
            json = localStorage[this.model.className];
            if (typeof json !== 'string') {
              return;
            }
            return this.model.refresh(JSON.parse(json), true);
          };

          Local.prototype.save = function() {
            var json;
            json = JSON.stringify(this.model.toJSON());
            return localStorage[this.model.className] = json;
          };
